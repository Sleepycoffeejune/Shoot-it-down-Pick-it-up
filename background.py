...
class Background(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.special_transitions = {
            ...
            # you can add more special transitions for other backgrounds
        }
    ...
    #trigger zones per background
        ...
        self.zones_by_bg = {
            ...
            # add more zones for other backgrounds as needed
        }
    ...
    def trans_L(self):
        try:
            for row in self.map_xl:              # loop through each row
                for i in range(len(row)):        # loop through each column
    ...
    def get_zones(self):
        """Return trigger zones for the current background"""
        return self.zones_by_bg.get(self.background, [])
    
    def get_special_transitions(self):
        """Return list of special transitions for current background"""
        return self.special_transitions.get(self.background, [])

    def get_borders(self):
        """Return list of border rects for the current background"""
